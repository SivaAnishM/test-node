...
const ledgerGroupPermissionAuthorization = async (req, res, next) => {
    try {
        ...
        req.ledgerGroupPermission = companyUser.permissions.accessByLedgerGroups;
...
module.exports = { ledgerGroupPermissionAuthorization };
