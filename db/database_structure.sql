...
create table mst_group (
    ...
    sort_position int,
    group_reserved_name varchar(1024) default ''
);
...
create table mst_vouchertype (
    ...
    voucher_reserved_name varchar(1024) default ''
);
...
create table mst_stock_item (
    ...
    closing_balance varchar(1024) default '',
    closing_value decimal(15, 4) default 0,
    last_sale_party varchar(1024) default '',
    last_purc_party varchar(1024) default '',
    closing_rate varchar(1024) default ''
);
...
create table trn_accounting (
    ...
    ledger varchar(1024) default '',
    _ledger varchar(64) default '',
    amount decimal(17, 2) default 0,
    amount_forex decimal(17, 2) default 0,
    currency varchar(1024) default '',
    bank_allocation_name varchar(1024) default '',
    bank_date varchar(1024) default '',
    bank_instrument_date varchar(1024) default '',
    transaction_type varchar(1024) default '',
    bank_name varchar(1024) default '',
    instrument_number varchar(1024) default '',
    unique_ref_number varchar(1024) default '',
    payment_mode varchar(1024) default '',
    bank_party varchar(1024) default '',
    bank_amount varchar(1024) default ''
);
